...
class TestInstance:
    ...
    def test_instance_creation(self):
        ...
        instance = Instance(name="web-server", id=1, resources=resources)
    ...
    def test_instance_with_numa_nodes(self):
        ...
        instance = Instance(name="numa-instance", id=1, resources=resources)
    ...
    def test_instance_with_cpu_affinity(self):
        ...
        instance = Instance(name="affinity-instance", id=1, resources=resources)
    ...
    def test_instance_with_memory_policy(self):
        ...
        instance = Instance(name="policy-instance", id=1, resources=resources)
